...
class SpherePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path1 = Path()
      ..addPath(parseSvgPathData(svg_path1), Offset(6945.46, -4740.49))
      ..close();

    canvas.drawPath(path1, Paint()..color = Colors.white.withOpacity(0.5));

    final path2 = Path()
      ..addPath(parseSvgPathData(svg_path2), Offset(7118.79, -4754.86))
      ..close();

    canvas.drawPath(path2, Paint()..color = Colors.white.withOpacity(0.17));

    final path3 = Path()
      ..addPath(parseSvgPathData(svg_path3), Offset(10.81, 195.44))
      ..close();
