...
class GlassPaths {
  static final svgPath1 = parseSvgPathData(
  ...
  static final svgPath2 = parseSvgPathData(
  ...
  static final svgPath3 = parseSvgPathData(
  ...
  final path1 = Path()
    ..addPath(svgPath1, Offset(6945.46, -4740.49))
    ..close();

  final path2 = Path()
    ..addPath(svgPath2, Offset(7118.79, -4754.86))
    ..close();

  final path3 = Path()
    ..addPath(svgPath3, Offset(10.81, 195.44))
    ..close();
}
